...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Hello! Welcome to the Hackathon Zodiac project! Would you like to know your Zodiac sign?"
        reprompt_text = "I was born on Nov. 6th, 2014. When were you born?"
...
class CaptureZodiacSignIntentHandler(AbstractRequestHandler):
    """Handler for CaptureZodiacSign Intent."""
    ...
    def handle(self, handler_input):
        ...
        url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vScKb6szuiu3XwnoAmN3idveGuDR2TOatJ5r8ryafWBBp4C_DJBFUX_X4_n4Og82jm0WG7CDZNGCOGQ/pub?gid=1494965002&single=true&output=csv"
